...
- `python3 /home/mjw/projects/baseball-openclaw/skills/mlb/mlb.py scores`
  — all of today's games (add `yesterday` or a date like `2026-08-05`)
- `python3 /home/mjw/projects/baseball-openclaw/skills/mlb/mlb.py dodgers`
  — Dodgers snapshot: recent results, upcoming games (with probable
  starters), NL West standing
- `python3 /home/mjw/projects/baseball-openclaw/skills/mlb/mlb.py ohtani`
  — Ohtani season stats, hitting AND pitching, plus recent games
- `python3 /home/mjw/projects/baseball-openclaw/skills/mlb/mlb.py schedule "Cubs" 5`
...
- `python3 /home/mjw/projects/baseball-openclaw/skills/mlb/mlb.py standings nl`
  — division standings (`al`, `nl`, or `all`)
- `python3 /home/mjw/projects/baseball-openclaw/skills/mlb/mlb.py player "Aaron Judge"`
  — any player's CURRENT TEAM and season stats; use for "who does X play for"
- `python3 /home/mjw/projects/baseball-openclaw/skills/mlb/mlb.py game "Angels"`
